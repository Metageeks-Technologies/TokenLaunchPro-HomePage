    ...
    <div className='flex flex-row justify-center '>
      ...
      <div>
       ...
       <Crypto />
        ...
        <div className='sm:justify-start mt-16 text-center justify-center flex myfont p-4 sm:p-8 text-3xl'>
         <h2> A Suite of Tools for Token Sales.</h2>
        </div>
        <div className="text-base text-center justify-center sm:px-8 px-4 text-zinc-700">
        ...
        <div className='sm:justify-start mt-16 text-center justify-center flex p-4 myfont sm:p-8 text-3xl'>
          A Growing Protocol Ecosystem
        </div>
        <div className="text-base text-center justify-center flex sm:px-8 px-4 text-zinc-700">
          A suite of tools were built to help you create your own tokens and
          launchpads in a fast, simple <br />and cheap way, with no prior code knowledge
          required and 100% decentralized!
